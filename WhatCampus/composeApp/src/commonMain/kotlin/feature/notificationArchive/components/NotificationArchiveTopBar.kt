...
import whatcampus.composeapp.generated.resources.notification_archive_title

@OptIn(ExperimentalMaterial3Api::class)
@Composable
internal fun NotificationArchiveTopBar(
    onClickBack: () -> Unit,
) {
    CenterAlignedTopAppBar(
        title = {
            Text(
                text = stringResource(Res.string.notification_archive_title),
